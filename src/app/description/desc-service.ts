...
export class DescService {
  ...
  private menusUrl2 = 'web/product/manual/find';
  private menusaddUrl = 'web/product/manual/update';
  ...
  create(manualName:string,manualVersion: string,manualDevice:string, manualInstructions: string,remark: string): Observable<Product> {
    ...
    html+=manualInstructions;
    html+=' </body></html>';
    let parment = 'manualName='+manualName+'&manualVersion='+manualVersion+'&manualDevice='+manualDevice+'&manualInstructions='+html+
